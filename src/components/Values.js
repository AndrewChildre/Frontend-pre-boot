...
export default function CenteredGrid() {
  ...
  return (
		<div className={classes.root}>
			<Grid className={classes.bgc} alignItems='stretch' container spacing={3}>
				<Grid item xs={12}>
				...
				<Grid item xs={6}>
					...
					behavior. Never lie, never cheat or steal; abide by an uncompromising
					code of integrity; respect human dignity and respect others. Honor
					compels Marines to act responsibly, to fulfill our obligations and to
					hold ourselves and others accountable for every action.
				</Grid>
				<Grid item xs={6}>
					COURAGE Courage is the mental, moral and physical strength ingrained
					in Marines. It carries us through the challenges of combat and aids in
				...
				<Grid item xs={6}>
					COMMITMENT Commitment is the spirit of determination and dedication
					found in Marines. It leads to the highest order of discipline for
